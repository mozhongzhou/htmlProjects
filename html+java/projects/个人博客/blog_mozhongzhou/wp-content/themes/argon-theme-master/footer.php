					<footer id="footer" class="site-footer card shadow-sm border-0">
						...
						?>
						<div>Theme <a href="https://github.com/solstice23/argon-theme" target="_blank"><strong>Argon</strong></a><?php if (get_option('argon_hide_footer_author') != 'true') {echo " By solstice23 Edited by 漠中洲"; }?></div>
					</footer>
				</main>
			</div>
		</div>
